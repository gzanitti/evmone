...
TEST_P(evm, eof1_rjumpi_backwards)
{
    ...
    //    rev = EVMC_CANCUN;
    //    auto code = eof1_bytecode(rjump(10) + mstore8(0, 1) + ret(0, 1) + rjumpi(-16,
    //    calldataload(0)) +
    //                                  mstore8(0, 2) + ret(0, 1),
    //        2);
    //
...
TEST_P(evm, eof1_rjumpv_multiple_offsets)
{
    ...
    //                                  rjumpv({12, -22, 0}, 1) + 10 + 78 + 0 + OP_CODECOPY + ret(0,
    //                                  10) + 20 + 68 + 0 + OP_CODECOPY + ret(0, 20),
    //        3, "ef000101000402000100010300000000000000fe");
    //
    //    execute(code);
    //    EXPECT_STATUS(EVMC_SUCCESS);
...
TEST_P(evm, eof1_rjumpv_long_jumps)
{
    ...
    //    rev = EVMC_CANCUN;
    //    auto code =
    //        rjump(0x7fff - 3 - 5) + (0x7fff - 3 - 2 - 8 - 5) * bytecode{OP_JUMPDEST} + 7 +
    //        ret_top();
    //
